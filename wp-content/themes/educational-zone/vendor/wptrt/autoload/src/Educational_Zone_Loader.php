...
class Educational_Zone_Loader {
	 ...
	 * @return void
	 */
	public function educational_zone_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function educational_zone_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function educational_zone_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function educational_zone_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->educational_zone_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function educational_zone_load( $class ) {
